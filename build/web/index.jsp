...
<head>
    ...
    <!-- Title -->
    <title>Ruvini - Gardening &amp; Landscaping HTML Template</title>
            ...
            <div class="classy-nav-container breakpoint-off">
                <div class="container">
                    ...
                    <nav class="classy-navbar justify-content-between" id="alazeaNav">
                        ...
                        <!-- Nav Brand -->
                        <a href="index.html" class="nav-brand"><img src="img/core-img/logo1.png" width="250px" height="22px" alt=""></a>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="img/Tissue-culture/alternanthera_reneckii.jpg" alt=""></a>
                                        <!-- Product Tag -->
                                    ...
                                    <!--   <div class="product-meta d-flex"> -->
                                          ...
                                          <!--  <a href="test.jsp" class="add-to-cart-btn">Add to cart</a>-->
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    <!-- Product Image -->
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="img/Tissue-culture/ammaniya_bonsai.jpg" alt=""></a>
                                        <div class="product-meta d-flex">
                                          <!--  <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a> 
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    <!-- Product Image -->
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="img/Tissue-culture/anubias_barteri.jpg" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <!--<a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>
                                            <a href="cart.html" class="add-to-cart-btn">Add to cart</a>
                                           <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a> -->
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    <!-- Product Image -->
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="img/Tissue-culture/anubias_barteri_broad_leaf.jpg" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <!--<a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a>-->
                                           <!-- <a href="cart.html" class="add-to-cart-btn">Add to cart</a> -->
                                            <!--<a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>-->
                                    ...
                                    <div class="product-info mt-15 text-center">
                                        <a href="shop-details.html">
                                            <p>Anubias Barteri Broad Leaf</p>
                                        </a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    <!-- Product Image -->
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="img/Tissue-culture/anubias_hasitifolia.jpg" alt=""></a>
                                        <div class="product-meta d-flex">
                                          <!--  <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a> -->
                                           <!-- <a href="cart.html" class="add-to-cart-btn">Add to cart</a> -->
                                            <!--<a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a>-->
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    <!-- Product Image -->
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="img/Tissue-culture/cryptocoryne_becketi_brown.jpg" alt=""></a>
                                        <div class="product-meta d-flex">
                                            <!--<a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a> -->
                                           <!-- <a href="cart.html" class="add-to-cart-btn">Add to cart</a> -->
                                           <!-- <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a> -->
                                    ...
                                    <div class="product-info mt-15 text-center">
                                        <a href="shop-details.html">
                                            <p>Cryptocoryne Becketi Brown</p>
                                        </a>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    <!-- Product Image -->
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="img/Tissue-culture/cryptocoryne_lutea.jpg" alt=""></a>
                                        <div class="product-meta d-flex">
                                          <!--  <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a> -->
                                          <!--  <a href="cart.html" class="add-to-cart-btn">Add to cart</a> -->
                                           <!-- <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a> -->
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    <!-- Product Image -->
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="img/Tissue-culture/cryptocoryne_parva.jpg" alt=""></a>
                                        <!-- Product Tag -->
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <div class="single-product-area mb-50">
                                    <!-- Product Image -->
                                    <div class="product-img">
                                        <a href="shop-details.html"><img src="img/Tissue-culture/cryptocoryne_pygmea.jpg" alt=""></a>
                                        <div class="product-meta d-flex">
                                        <!--    <a href="#" class="wishlist-btn"><i class="icon_heart_alt"></i></a> -->
                                         <!--   <a href="cart.html" class="add-to-cart-btn">Add to cart</a> -->
                                         <!--   <a href="#" class="compare-btn"><i class="arrow_left-right_alt"></i></a> -->
                    ...
                    <div class="col-12 col-sm-6 col-lg-3">
                        <div class="single-footer-widget">
                            ...
                            <div class="contact-information">
                                <p><span>Address:</span> No: 55/6,Koralawella, Moratuwa,Sri Lanka</p>
                                <p><span>Phone:</span> +1 234 122 122</p>
                                <p><span>Email:</span> ruviniaquaplants@gmail.com</p>
